...
| Formato | Uso |
|---|---|
| **AppImage** | Qualquer distro: `chmod +x protoncommand-0.2.0.x86_64.AppImage && ./protoncommand-0.2.0.x86_64.AppImage` |
| **.deb** | Debian/Ubuntu: `sudo dpkg -i protoncommand-0.2.0.x86_64.deb` |
| **.rpm** | Fedora/openSUSE: `sudo rpm -i protoncommand-0.2.0.x86_64.rpm` |
...
| Format | Usage |
|---|---|
| **AppImage** | Any distro: `chmod +x protoncommand-0.2.0.x86_64.AppImage && ./protoncommand-0.2.0.x86_64.AppImage` |
| **.deb** | Debian/Ubuntu: `sudo dpkg -i protoncommand-0.2.0.x86_64.deb` |
| **.rpm** | Fedora/openSUSE: `sudo rpm -i protoncommand-0.2.0.x86_64.rpm` |
